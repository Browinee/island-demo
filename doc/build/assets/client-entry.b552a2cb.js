...
function hr(e, n, t, r, l) {
  ...
  if (((o = 0), (r = r === '' ? '.' : r + ':'), Io(e)))
    ...
    for (e = s.call(e), i = 0; !(u = e.next()).done; )
      (u = u.value), (s = r + wl(u, i++)), (o += hr(u, n, t, s, l));
  else if (u === 'object')
    throw (
      ((n = String(e)),
      Error(
...
const zr = Vu.exports.jsx,
  jo = Vu.exports.jsxs;
function Cc() {
  const [e, n] = br.exports.useState(0);
  return jo('div', {
    children: [
      zr('h1', { children: 'This is Layout Component' }),
      jo('div', {
        children: [
          e,
          zr('button', { onClick: () => n(e + 1), children: 'Add Count' })
        ]
      })
    ]
  });
  ...
  function E(C, N) {
    ...
    try {
      ...
      if (m !== null) var Jt = !0;
        ...
        var vn = t(c);
        vn !== null && yl(h, vn.startTime - N), (Jt = !1);
      }
      return Jt;
    } finally {
      (m = null), (p = z), (g = !1);
...
function vs() {
  if (Qn) {
    var e = Qn,
      n = Kn;
    if (((Kn = Qn = null), Qo(e), n)) for (e = 0; e < n.length; e++) Qo(n[e]);
  }
}
function hs(e, n) {
  return e(n);
...
function gr(e) {
  ...
  for (var n = e.targetContainers; 0 < n.length; ) {
    ...
    } else return (n = Gt(t)), n !== null && Ju(n), (e.blockedOn = t), !1;
    n.shift();
  }
  return !0;
}
...
function qu(e, n, t, r) {
  if (Dr) {
    var l = au(e, n, t, r);
    if (l === null) Dl(e, n, r, Ir, t), Xo(e, r);
    else if (Jc(l, e, n, t, r)) r.stopPropagation();
    else if ((Xo(e, r), n & 4 && -1 < Zc.indexOf(e))) {
      for (; l !== null; ) {
        var u = Gt(l);
        if (
          (u !== null && Ns(u),
...
var vf = A({}, Xt, {
  ...
  wf = ge(gf),
  kf = A({}, lt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Sf = ge(kf),
  Ef = A({}, tl, {
    deltaX: function (e) {
...
function $s(e) {
  if (e.propertyName === 'value' && rl(It)) {
    var n = [];
    js(n, It, e, Xu(e)), gs(Tf, n);
  }
}
function Rf(e, n, t) {
  e === 'focusin'
    ? (li(), (Ct = n), (It = t), Ct.attachEvent('onpropertychange', $s))
    : e === 'focusout' && li();
}
function Of(e) {
...
function jt(e) {
  if (!e[sr]) {
    ...
    n === null || n[sr] || ((n[sr] = !0), Ml('selectionchange', !1, n));
  }
}
function Gs(e, n, t, r) {
  switch (Os(n)) {
...
function mn() {
  if (!Fl && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Es(Gu, mn), l);
    } finally {
      (O = n), (Fl = !1);
    }
  }
...
function Eu(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = ra), fo(e);
  var u = n.contextType;
  typeof u == 'object' && u !== null
    ? (l.context = Ce(u))
...
var Yr = {
  ...
  ed = {
    ...
    useSyncExternalStore: function (e, n, t) {
      ...
      return (
        (l.queue = u),
        _i(da.bind(null, r, u, e), [e]),
        (r.flags |= 2048),
        Wt(9, fa.bind(null, r, u, t, n), void 0, null),
        t
      );
    },
    useId: function () {
...
function Li(e, n, t, r, l) {
  ...
  if ((Xn(n, l), n.stateNode === null))
    _r(e, n), la(n, t, r), Eu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function xu(e, n, t, r, l, u) {
  Ra(e, n);
  var o = (n.flags & 128) !== 0;
  if (!r && !o) return l && vi(n, t, !1), Ke(e, n, u);
...
function ud(e, n, t, r, l, u, o) {
  if (t)
    return n.flags & 256
      ? ((n.flags &= -257), (r = Vl(Error(y(422)))), dr(e, n, o, r))
      : n.memoizedState !== null
      ...
      : ((u = r.fallback),
        ...
        (r.sibling = u),
        (n.child = r),
        (n.mode & 1) !== 0 && bn(n, e.child, null, o),
        (n.child.memoizedState = Nu(o)),
        (n.memoizedState = Pu),
        u);
  if ((n.mode & 1) === 0) return dr(e, n, o, null);
  if (l.data === '$!') {
    if (((r = l.nextSibling && l.nextSibling.dataset), r)) var i = r.dgst;
    return (r = i), (u = Error(y(419))), (r = Vl(u, r, void 0)), dr(e, n, o, r);
  }
  if (((i = (o & e.childLanes) !== 0), ae || i)) {
    ...
    return No(), (r = Vl(Error(y(421)))), dr(e, n, o, r);
  }
  return l.data === '$?'
    ? ((n.flags |= 128),
      (n.child = e.child),
...
function id(e, n, t) {
  ...
  switch ((uo(n), n.tag)) {
    ...
    case 4:
      return (
        et(), zu(e, n), e === null && jt(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[$t], delete n[hu], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Re(e, n, t, r) {
  if (50 < zt) throw ((zt = 0), (Du = null), Error(y(185)));
  Yt(e, t, r),
    ((R & 2) === 0 || e !== Z) &&
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Yo(t), n === 1))
      e.tag === 0 ? Xf($i.bind(null, e)) : Js($i.bind(null, e)),
        Wf(function () {
          (R & 6) === 0 && mn();
        }),
        (t = null);
...
function Ha(e, n) {
  if (((xr = -1), (Pr = 0), (R & 6) !== 0)) throw Error(y(327));
  var t = e.callbackNode;
...
Ga = function (e, n, t) {
  ...
  else (ae = !1), j && (n.flags & 1048576) !== 0 && qs(n, Vr, n.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zu(n, t | 1), de(n, W()), (R & 6) === 0 && ((tt = W() + 500), mn()));
      }
      break;
    case 13:
      zn(function () {
...
hs = xo;
ys = zn;
var Pd = { usingClientEntryPoint: !1, Events: [Gt, jn, ul, ms, vs, xo] },
  vt = {
